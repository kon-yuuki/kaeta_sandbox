...
class AppTypography extends ThemeExtension<AppTypography> {
  const AppTypography({
    ...
    required this.titleSm16B160,
    required this.std20M160,
    required this.std18Sb160,
  ...
  final TextStyle titleSm16B160;
  final TextStyle std20M160;
  final TextStyle std18Sb160;
  ...
  AppTypography copyWith({
    ...
    TextStyle? titleSm16B160,
    TextStyle? std20M160,
    TextStyle? std18Sb160,
    TextStyle? std18R160,
    TextStyle? std16B150,
    TextStyle? std16R160,
    TextStyle? std16R175,
    ...
    return AppTypography(
      ...
      titleSm16B160: titleSm16B160 ?? this.titleSm16B160,
      std20M160: std20M160 ?? this.std20M160,
      std18Sb160: std18Sb160 ?? this.std18Sb160,
  ...
  AppTypography lerp(ThemeExtension<AppTypography>? other, double t) {
    ...
    return AppTypography(
      dsp22B140: TextStyle.lerp(dsp22B140, other.dsp22B140, t)!,
      ...
      jaOnl12M120: TextStyle.lerp(jaOnl12M120, other.jaOnl12M120, t)!,
      ...
      titleSm16B160: TextStyle.lerp(titleSm16B160, other.titleSm16B160, t)!,
      std20M160: TextStyle.lerp(std20M160, other.std20M160, t)!,
      std18Sb160: TextStyle.lerp(std18Sb160, other.std18Sb160, t)!,
...
final lightAppTypography = AppTypography(
  dsp22B140: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 22,
    height: 1.4,
    fontWeight: FontWeight.w700,
    color: Color(0xFF2C3844),
  )),
  dsp21B140: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 21,
    height: 1.4,
    fontWeight: FontWeight.w700,
    color: Color(0xFF2C3844),
  )),
  jaOnl16M130: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 16,
    height: 1.3,
    fontWeight: FontWeight.w500,
    color: Color(0xFF2C3844),
  )),
  jaOnl16R120: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 16,
    height: 1.2,
    fontWeight: FontWeight.w400,
    color: Color(0xFF2C3844),
  )),
  jaOnl12M120: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 12,
    height: 1.2,
    fontWeight: FontWeight.w500,
    color: Color(0xFF2C3844),
  )),
  jaOnl14B100: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 14,
    height: 1.0,
    fontWeight: FontWeight.w700,
    color: Color(0xFF2C3844),
  )),
  jaOnl14Sb100: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 14,
    height: 1.0,
    fontWeight: FontWeight.w600,
    color: Color(0xFF2C3844),
  )),
  jaOnl12B100: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 12,
    height: 1.0,
    fontWeight: FontWeight.w700,
    color: Color(0xFF2C3844),
  )),
  jaOnl11M100: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 11,
    height: 1.0,
    fontWeight: FontWeight.w500,
    color: Color(0xFF2C3844),
  )),
  egOnl26R120: _withPalt(GoogleFonts.inter(
    fontSize: 26,
    height: 1.2,
    fontWeight: FontWeight.w400,
    color: Color(0xFF2C3844),
  )),
  egOnl16M160: _withPalt(GoogleFonts.inter(
    fontSize: 16,
    height: 1.6,
    fontWeight: FontWeight.w500,
    color: Color(0xFF2C3844),
  )),
  egOnl12M140: _withPalt(GoogleFonts.inter(
    fontSize: 12,
    height: 1.4,
    fontWeight: FontWeight.w500,
    color: Color(0xFF2C3844),
  )),
  titleSm16B160: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 16,
    height: 1.6,
    fontWeight: FontWeight.w700,
    color: Color(0xFF2C3844),
  )),
  std20M160: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 20,
    height: 1.6,
    fontWeight: FontWeight.w500,
    color: Color(0xFF2C3844),
  )),
  std18Sb160: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 18,
    height: 1.6,
    fontWeight: FontWeight.w600,
    color: Color(0xFF2C3844),
  )),
  std18R160: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 18,
    height: 1.6,
    fontWeight: FontWeight.w400,
    color: Color(0xFF2C3844),
  )),
  std16B150: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 16,
    height: 1.5,
    fontWeight: FontWeight.w700,
    color: Color(0xFF2C3844),
  )),
  std16R160: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 16,
    height: 1.6,
    fontWeight: FontWeight.w400,
    color: Color(0xFF2C3844),
  )),
  std16R175: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 16,
    height: 1.75,
    fontWeight: FontWeight.w400,
    color: Color(0xFF2C3844),
  )),
  std14B160: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 14,
    height: 1.6,
    fontWeight: FontWeight.w700,
    color: Color(0xFF2C3844),
  )),
  std14R160: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 14,
    height: 1.6,
    fontWeight: FontWeight.w400,
    color: Color(0xFF2C3844),
  )),
  std12B160: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 12,
    height: 1.6,
    fontWeight: FontWeight.w700,
    color: Color(0xFF2C3844),
  )),
  std12M160: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 12,
    height: 1.6,
    fontWeight: FontWeight.w500,
    color: Color(0xFF2C3844),
  )),
  std11B140: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 11,
    height: 1.4,
    fontWeight: FontWeight.w700,
    color: Color(0xFF2C3844),
  )),
  std11M160: _withPalt(GoogleFonts.notoSansJp(
    fontSize: 11,
    height: 1.6,
    fontWeight: FontWeight.w500,
    color: Color(0xFF2C3844),
...
TextStyle _withPalt(TextStyle style) {
  return style.copyWith(
    fontFeatures: const [ui.FontFeature.enable('palt')],
  );
}
